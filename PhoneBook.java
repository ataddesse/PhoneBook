...
class MainFrame extends JFrame
{
    ...
    public MainFrame(String title)
    {
        ...
        Border tipBorder = BorderFactory.createTitledBorder(border, "Tips");
        JPanel tipPanel = new JPanel();
        tipPanel.setBorder(tipBorder);
...
class PhoneBook
{
    ...
    {
        PhoneBookManager manager = PhoneBookManager.createManagerInst();
        MainFrame winFrame = new MainFrame("Phone Book by Amanuel & Rohit                                         Tips: Search and Delete are case sensitive");
    }
}